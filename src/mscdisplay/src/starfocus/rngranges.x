...
char	ranges[SZ_LINE]
real	r1, r2, dr, clgetr(), rng_nearest()
bool	rng_inrange()
int	i, rng_index()
pointer	rg, rng_open()

begin
	call clgstr ("ranges", ranges, SZ_LINE)
	r1 = clgetr ("r1")
	r2 = clgetr ("r2")
	dr = clgetr ("dr")
	rg = rng_open (ranges, r1, r2, dr)

	for (i = 1; rng_index (rg, i, r1) != EOF; i = i + 1) {
	    call printf ("%g\n")
		call pargr (r1)
	}
	...
	repeat {
	    ...
	    if (IS_INDEFR(r1))
		break
	    dr = rng_nearest (rg, r1, i, r2)
	    call printf ("%g: %d %g %g %b\n")
		call pargr (r1)
		call pargi (i)
		call pargr (r2)
		call pargr (dr)
		call pargb (rng_inrange (rg, r1))
	}
