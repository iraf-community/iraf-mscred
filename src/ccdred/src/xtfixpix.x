...
pointer procedure xx_fpinit (pmin, lvalin, cvalin)
...
begin
	...
	call xx_fpsinterp (pmin, pm, nc, nl, v, Mems[buf], lvalin, cvalin,
	    lval, cval)
...
procedure xx_fpsinterp (pmin, pm, nc, nl, v, data, lvalin, cvalin,
	lvalout, cvalout)
